    ...
    const fetchData = async () => {
      ...
      try {
        ...
        setRestaurant({
          ...
          menu: menuData,
          reviews: r.reviews || [],
          photos: (r.restaurantImages || []).map(img => img.imageUrl),
        });
  ...
  return (
    <div className="restaurant-details-page">
      ...
      <div className="tabs-bar">
        {["overview", "reviews", "photos", "menu"].map((tab) => (
          <button
            key={tab}
        ...
        <div className="left-content">
          ...
          {activeTab === "menu" && (
            <div className="menu-tab-content">
              <img src={imageUrl} alt="Menu Banner" className="menu-banner" />
              <Menu menu={menu} viewOnly={true} />
            </div>
          )}
        </div>
